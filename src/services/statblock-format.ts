...
interface StatblockFormatRuntime {
    ...
    createEnvelope(input: any | any[]): { type: string; version: string; exportDate: string; data: any | any[] };
...
export const normalizeStatblockData = (input: any, declaredType?: string): StatblockData | null => runtime.normalizeStatblock(input, declaredType);
...
export const normalizeStatblockPayload = (input: string | object): NormalizedImportEntry[] => runtime.normalizePayload(input);
