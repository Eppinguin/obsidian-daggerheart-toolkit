...
const fixedFiles = [
  'parser.js', 'parser-patch.js', 'heartofdaggers-filter.js', 'freshcutgrass-parser.js',
  'freshcutgrass-state.js', 'freshcutgrass-rendered-repair.js',
  'freshcutgrass-card-boundary.js', 'content-script.js', 'popup.js', 'options.js'
];
